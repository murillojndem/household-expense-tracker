...
import styles from './TotaisPorCategoriaTable.module.css';

interface TotaisPorCategoriaTableProps {
  data: RelatorioConsolidado<TotalPorCategoria> | null;
}

export function TotaisPorCategoriaTable({ data }: TotaisPorCategoriaTableProps) {
  ...
  return (
    <Card>
      <h2 className={styles.title}>Totais por Categoria</h2>
      <table>
        <thead>
          <tr>
            <th>Categoria</th>
